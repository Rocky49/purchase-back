...
@Entity
@Table(name = "other_invoice_master")
public @Getter @Setter class OtherInvoiceMaster {
	
	@Id
	@Column(nullable = false, name = "other_invoice_id")
	...
	@Column(nullable = false, name = "purchase_details")
	...
	@Column(nullable = true, name = "credit_note_number")
	private String creditNoteNumber;
	@Column(nullable = true, name = "credit_note_amt")
	private Double creditNoteAmt;
	@Column(nullable = false, name = "total_payable")
	private Double totalPayable;
	@Column(nullable = true, name = "cheque_number")
	private Long chequeNumber;
	@Column(nullable = true, name = "cheque_date")
	private Date chequeDate;
	@Column(nullable = true, name = "cheque_amt")
	private Double chequeAmt;
	@Column(nullable = true, name = "received_on")
